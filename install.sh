...
declare -a exercises=("0-create-app-with-vite" "1-create-vue-component" "2-dynamic-data-events-template-syntax" "3-forms" "4-component-communication" "5-fetch-data-and-component-lifecycle" "6-composition-api")
